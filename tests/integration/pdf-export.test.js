...
const jsPDFConstructorMock = function () {
  ...
  return {
    ...
    save: function () { // This is the doc.save() method
    ...
    save: function (filename) { // This is the doc.save(filename) method
...
global.document = {
  currentScript: { src: "chrome-extension://test-extension-id/extension/pdf-exporter.js" }, // Mock currentScript.src
...
const markdownScript = new Function(
  "window",
  "global",
  "module",
  "exports",
...
markdownScript(sandbox.window, sandbox, sandbox.module, sandbox.exports);
